...
\doubt{Nothing drafted as prose here yet, per your note. Section~\ref{sec:results}
now has real numbers, so this section can close the loop back to
Section~\ref{sec:introduction}'s motivation whenever you're ready to draft
it. Suggested threads to pick up, in a plausible reading order:}
